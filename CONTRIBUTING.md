...
Please [open an issue](https://github.com/serokell/danger/issues) if you find
a bug or have a feature request. Before submitting a bug report or feature
request, check to make sure it hasn't already been submitted.

The more detailed your report is, the faster it can be resolved. If you
report a bug, please provide steps to reproduce this bug and the revision of
...
Our pull request template contains a [checklist](.github/pull_request_template.md#white_check_mark-checklist-for-your-pull-request)
...
but, basically, it all boils down to the following:
  ...
  * Add the following header at the very top (but below the shebang, if there
    ...
    (This is an example for Ruby; adapt it as needed for other languages.)

...
RSpec.describe "merge-commits check" do
  ...
  # It's not confirmed whether this exact set of prefixes is a strict
  # requirement or just a heuristic to avoid false triggers; this test
  # only pins current behavior, not necessarily the intended contract.
  # See https://github.com/serokell/danger/issues/11.
